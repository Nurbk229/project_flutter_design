...
import 'package:assigment_2/home_screen.dart';
...
class _Login extends State<Login> {
  ...
  List<String> spinnerItems = ['Albania', 'Bridgetown', 'Manama', 'Angola', 'Luanda'];
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          TextFormField(
                            obscureText: true,
                            decoration: bgTextFiled(inputType,
                                inputType, passwordIsEmpty),
                          ),
                          Container(
